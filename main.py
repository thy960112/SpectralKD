...
def get_args_parser():
    parser = argparse.ArgumentParser('SpectralKD', add_help=False)
    parser.add_argument('--batch-size', default=256, type=int)
    parser.add_argument('--epochs', default=400, type=int)

    parser.add_argument('--distillation-beta', default=1.0, type=float)
    parser.add_argument('--w-fft', default=0.2, type=float)
    ...
    parser.add_argument('--distillation-type', default='none', choices=['none', 'fft', 'soft', 'hard'], type=str, help="")
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            args.clip_grad, model_ema, mixup_fn, args.distillation_type, args.s_id, args.t_id,
        ...
        current_accuracy = test_stats["acc1"]
        ...
        if args.output_dir:
            ...
            if is_best:
                ...
                print(f'New best model saved at epoch {epoch} with accuracy {current_accuracy:.2f}%')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('SpectralKD training and evaluation script', parents=[get_args_parser()])
